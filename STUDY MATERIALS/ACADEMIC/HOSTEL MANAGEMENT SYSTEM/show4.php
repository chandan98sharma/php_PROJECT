...
<br>
<font size="5"><center><b><p style="border:3px inset skyblue;margin-left:25%;margin-right:25%;">Your Activity details</p></b></center></font>
<br><br>
<font color=orange>
<p align="center">
<?php
...
$Check = "SELECT activity_id FROM user_hostel_details WHERE registration_number='$r'";
$result = mysqli_query($conn,$Check);
$row2 = mysqli_fetch_assoc($result);
$temp=$row2['activity_id'];
$sql1 = "SELECT * FROM activity_details where activity_id='$temp'";
$result1 = mysqli_query($conn, $sql1);

if (mysqli_num_rows($result1) > 0) 
	{
		$row = mysqli_fetch_assoc($result1);
        echo "Activity id : " . $row["activity_id"]. "<br>  Activity name: " . $row["activity_name"]. "<br> Activity time :" . $row["activity_time"]. "<br> Fees : " .$row["fees"] ;
    } 
else {
