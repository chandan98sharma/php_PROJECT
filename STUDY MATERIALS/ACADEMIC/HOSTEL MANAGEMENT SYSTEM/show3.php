...
<br>
<font size="5"><center><b><p style="border:3px inset skyblue;margin-left:25%;margin-right:25%;">Your Room details</p></b></center></font>
<br><br>
<font color=orange>
<p align="center">
<?php
...
$Check = "SELECT room_no FROM user_hostel_details WHERE registration_number='$r'";
$result = mysqli_query($conn,$Check);
$row2 = mysqli_fetch_assoc($result);
$temp=$row2['room_no'];
$sql1 = "SELECT * FROM room_details where room_no='$temp'";
$result1 = mysqli_query($conn, $sql1);

if (mysqli_num_rows($result1) > 0) 
	{
		$row = mysqli_fetch_assoc($result1);
        echo "Room number : " . $row["room_no"]. "<br>  Room Type: " . $row["room_type"]. "<br> number of beds :" . $row["no_of_bed"]. "<br> Fees : " .$row["fees"] ;
    } 
else {
