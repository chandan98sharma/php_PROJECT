...
$sql = "SELECT * FROM personal_details where registration_number='$r'";
...
if (mysqli_num_rows($result) > 0) 
	{
        ...
        echo "registration_number : " . $row["registration_number"]. "<br>  Name: " . $row["name"]. "<br> Father name :" . $row["father_name"]. "<br> Date of birth : " .$row["date_of_birth"]. "<br> Mobile number : " . $row["mobile_number"]."<br> Address : ".$row["address"] ;
    } 
else {
